...
export default function FinanceVirementPage() {
  ...
  // Form State
  const [fromAccountType, setFromAccountType] = useState('Agency');
  const [fromAccountName, setFromAccountName] = useState('True Travel');
  const [transactionType, setTransactionType] = useState('Debt');

  const [amount, setAmount] = useState('');
  const [currency, setCurrency] = useState('USD');

  const [toAccountType, setToAccountType] = useState('Agency');
  const [toAccountName, setToAccountName] = useState('Select');
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="mb-6">
          <h2 className="text-3xl font-light text-gray-800">Virement</h2>
          ...
          <div className="p-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-1">
                <label className="block text-sm font-medium text-orange-500 mb-2">&nbsp;</label>
                <select
                  value={currency}
              ...
              <div className="lg:col-span-9">
                ...
                <textarea
                  ...
                  className="w-full min-h-[90px] px-4 py-3 border border-gray-300 bg-white rounded-none focus:outline-none focus:ring-2 focus:ring-orange-500 resize-none"
                />
              </div>
