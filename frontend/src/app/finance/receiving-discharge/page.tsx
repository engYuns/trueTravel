...
export default function FinanceReceivingDischargePage() {
  ...
  // Form State
  const [transactionType, setTransactionType] = useState('Receiving');
  ...
  const ClockIcon = () => (
    <svg className="w-5 h-5 text-gray-400" fill="currentColor" viewBox="0 0 24 24">
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 11H7V11h4V6h2v7z" />
    </svg>
  );
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="mb-6">
          <h2 className="text-3xl font-light text-gray-800">Receiving &amp; Discharge</h2>
          <div className="mt-2 text-sm text-gray-500">
            <a href="/dashboard" className="text-blue-600 hover:underline">
              Homepage
            </a>{' '}
            <span className="mx-2">»</span>
            <span className="text-gray-400">Receiving &amp; Discharge</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-orange-500 rounded-sm overflow-hidden">
          ...
          <div className="p-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-3">
                <label className="block text-sm font-medium text-orange-500 mb-2">Account Name</label>
                <input
                  type="text"
                  value={accountName}
              ...
              {/* Row 2 */}
              <div className="lg:col-span-3">
                <label className="block text-sm font-medium text-orange-500 mb-2">Transaction time</label>
                <div className="grid grid-cols-2">
                  ...
                  <div className="relative">
                    <div className="pointer-events-none absolute inset-y-0 left-3 flex items-center">{ClockIcon()}</div>
                    <input
                      type="time"
              ...
              <div className="lg:col-span-3">
                <label className="block text-sm font-medium text-orange-500 mb-2">Payment Date</label>
                <div className="grid grid-cols-2">
                  <div className="relative">
                    <div className="pointer-events-none absolute inset-y-0 left-3 flex items-center">{CalendarIcon()}</div>
                    <input
              ...
              <div className="lg:col-span-5">
                <label className="block text-sm font-medium text-orange-500 mb-2">Description</label>
                <textarea
                  value={description}
                  onChange={(e) => setDescription(e.target.value.slice(0, descriptionMax))}
                  className="w-full min-h-[110px] px-4 py-3 border border-gray-300 bg-white rounded-none focus:outline-none focus:ring-2 focus:ring-orange-500 resize-none"
                />
