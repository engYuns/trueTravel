  ...
  return (
    <div className="min-h-screen bg-gray-100">
              ...
              {showAgencyDropdown && (
                <div className="absolute top-full left-0 mt-0 w-56 bg-black rounded-lg shadow-lg py-2 z-[999999] border border-gray-700">
                  ...
                  <a href="/agency/customers" className="block px-4 py-3 text-white hover:bg-gray-800 transition-colors">
                    <div className="flex items-center space-x-3">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 0 1 8 0zM12 14a7 7 0 0 0-7 7h14a7 7 0 0 0-7-7z" />
                      </svg>
                    ...
                    <div className="flex items-center space-x-3">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          d="M9 5H7a2 2 0 00-2 2v12a2 2 0 00 2 2h10a2 2 0 00 2-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"
                        />
                      </svg>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="mb-4">
          <h2 className="text-3xl font-light text-gray-800">Agency Accounts</h2>
          <div className="mt-2 text-sm text-gray-500">
            <a href="/dashboard" className="text-blue-600 hover:underline">
              Homepage
            </a>{' '}
            <span className="mx-2">»</span>
            <span className="text-gray-400">Agency Accounts</span>
          </div>
        </div>
          ...
          <div className="flex items-center gap-10">
            <button
              ...
              className={`flex items-center gap-2 pb-3 border-b-4 transition-colors ${
                activeTab === 'accounts' ? 'border-teal-400 text-gray-800' : 'border-transparent text-gray-500 hover:text-gray-700'
              }`}
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-lg">Agency Accounts</span>
            </button>
            ...
            <button
              ...
              className={`flex items-center gap-2 pb-3 border-b-4 transition-colors ${
                activeTab === 'detail' ? 'border-teal-400 text-gray-800' : 'border-transparent text-gray-500 hover:text-gray-700'
              }`}
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" />
              </svg>
              <span className="text-lg">Agency Accounts ( Detail )</span>
            </button>
            ...
            <button
              ...
              className={`flex items-center gap-2 pb-3 border-b-4 transition-colors ${
                activeTab === 'discharge' ? 'border-teal-400 text-gray-800' : 'border-transparent text-gray-500 hover:text-gray-700'
              }`}
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
              </svg>
              <span className="text-lg">Agency ( Discharge / Collection )</span>
            </button>
          </div>
        </div>
        ...
        {activeTab === 'accounts' && (
          <>
            ...
            <div className="bg-white border border-orange-500 rounded-sm overflow-hidden mb-6">
              ...
              {/* Invoice */}
              <div>
                <label className="block text-sm font-medium text-orange-500 mb-2">Invoice</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-none focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                  />
                </div>
              </div>
              ...
              {/* Seller */}
              <div>
                <label className="block text-sm font-medium text-orange-500 mb-2">Seller</label>
                <div className="relative">
                  <div className="pointer-events-none absolute inset-y-0 left-3 flex items-center">
                    <div className="w-4 h-4 rounded-full border-2 border-gray-300" />
                  </div>
              ...
              {/* Account Type */}
              <div>
                <label className="block text-sm font-medium text-orange-500 mb-2">Account Type</label>
                <select
                  value={accountType}
              ...
              <div className="flex items-end">
                <button
                  ...
                  className="w-full md:w-auto px-8 py-2 bg-orange-500 text-white rounded-md hover:bg-orange-600 transition-colors font-medium flex items-center justify-center space-x-2"
                >
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 mb-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Page Displayed */}
            <div className="bg-white border border-gray-300 overflow-hidden w-full md:w-[340px]">
              <div className="bg-orange-500 text-white px-5 py-2">
                <h3 className="text-lg font-medium">Page Displayed</h3>
              </div>
              <div className="p-4">
                <div className="grid grid-cols-2 gap-y-3 text-base">
                  <span className="text-orange-500 font-semibold">Debt</span>
                  <span className="text-gray-800 text-right">0 USD</span>

                  <span className="text-orange-500 font-semibold">Receivable</span>
                  <span className="text-gray-800 text-right">
                    1015.28 USD <span className="text-green-600 font-bold">+</span>
                  </span>
            ...
            <div className="bg-white border border-gray-300 overflow-hidden w-full md:w-[340px]">
              <div className="bg-orange-500 text-white px-5 py-2">
                <h3 className="text-lg font-medium">All Pages Listed</h3>
              </div>
              <div className="p-4">
                <div className="grid grid-cols-2 gap-y-3 text-base">
                  <span className="text-orange-500 font-semibold">Total Debt</span>
                  <span className="text-gray-800 text-right">0 USD</span>

                  <span className="text-orange-500 font-semibold">Total Receivable</span>
                  <span className="text-gray-800 text-right">
                    1015.28 USD <span className="text-green-600 font-bold">+</span>
                  </span>
          ...
          <div className="flex flex-col items-end gap-4 w-full lg:w-auto">
            ...
            <div className="flex flex-wrap items-center justify-end gap-3">
              <button
                type="button"
                className="px-4 py-2 border border-blue-300 rounded-md bg-white text-blue-700 hover:bg-blue-50 transition-colors font-medium flex items-center gap-2"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center justify-end gap-3">
              ...
              <input
                ...
                className="w-14 px-2 py-2 bg-gray-200 border border-gray-300 rounded-none text-center focus:outline-none focus:ring-2 focus:ring-orange-500"
              />
              <select
                value={itemsPerPage}
                onChange={(e) => {
            ...
            <table id="export-table" className="w-full">
              <thead className="bg-gray-700 text-white">
                <tr>
                  ...
                  <th className="px-4 py-4 text-left font-semibold">Administrator</th>
                  <th className="px-4 py-4 text-center font-semibold">Pending Commission</th>
                  <th className="px-4 py-4 text-center font-semibold">Outstanding Balance</th>
                  <th className="px-4 py-4 text-center font-semibold">Net Balance</th>
                  <th className="px-4 py-4 text-center font-semibold">Currency</th>
                ...
                {filteredRows.length === 0 ? (
                  ...
                  pagedRows.map((row) => (
                    <tr key={row.id} className="border-t border-gray-200 bg-gray-50">
                      ...
                      <td className="px-4 py-4 text-sm text-gray-700">{row.administrator}</td>
                      <td className="px-4 py-4 text-sm text-blue-600 text-center">
                        {row.pendingCommission} <span className="text-green-600 font-bold">+</span>
                      </td>
                      <td className="px-4 py-4 text-sm text-gray-800 text-center">
                        {row.outstandingBalance} <span className="text-green-600 font-bold">+</span>
                      </td>
                      <td className="px-4 py-4 text-sm text-gray-800 text-center">
                        {row.netBalance} <span className="text-green-600 font-bold">+</span>
                      </td>
