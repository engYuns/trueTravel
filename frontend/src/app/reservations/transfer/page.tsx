...
export default function ReservationsTransferPage() {
  ...
  const [meetingInformation, setMeetingInformation] = useState('All');
  ...
  const handleSearch = () => {
    console.log('Searching transfer reservations with criteria:', {
      dateFrom,
      timeFrom,
      dateTo,
      timeTo,
  ...
  const handleExport = async (type: 'copy' | 'excel' | 'pdf' | 'print') => {
    ...
    if (type === 'print') {
      printTable('#export-table', 'Reservations - Transfer');
      return;
    }
    if (type === 'copy') {
    ...
    if (type === 'excel') {
      await exportTableToExcel('reservations-transfer.xlsx', data);
      return;
    }
    await exportTableToPdf('reservations-transfer.pdf', 'Reservations - Transfer', data);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="mb-6">
          <h2 className="text-3xl font-light text-gray-800">Transfer</h2>
        ...
        <div className="bg-white border border-orange-500 rounded-sm overflow-hidden mb-8">
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex gap-3">
                    ...
                    <input
                      ...
                      className="w-28 shrink-0 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                    />
                  </div>
              ...
              {/* Meeting Information */}
              <div>
                <label className="block text-sm font-medium text-orange-500 mb-2">Meeting Information</label>
                <select
                  value={meetingInformation}
                  onChange={(e) => setMeetingInformation(e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                >
                  ...
                  <table className="w-full">
                    <thead className="bg-gray-100">
                      <tr>
                        ...
                        <th className="px-4 py-4 text-center text-base font-bold text-gray-900">Transfer</th>
            ...
            <table id="export-table" className="w-full">
              <thead className="bg-gray-700 text-white">
                <tr>
                  ...
                  <th className="px-4 py-4 text-left font-semibold">Transfer Date</th>
                  <th className="px-4 py-4 text-left font-semibold">Transfer</th>
                  <th className="px-4 py-4 text-left font-semibold">Guest</th>
                  <th className="px-4 py-4 text-left font-semibold">Route</th>
                  <th className="px-4 py-4 text-left font-semibold">Meeting Information</th>
                ...
                {reservations.length === 0 ? (
                  ...
                  reservations.map((row, idx) => (
                    <tr key={idx} className="border-t border-gray-200 hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-sm text-gray-700">{row.transferDate}</td>
                      <td className="px-4 py-3 text-sm text-gray-700">{row.transfer}</td>
                      <td className="px-4 py-3 text-sm text-gray-700">{row.guest}</td>
                      <td className="px-4 py-3 text-sm text-gray-700">{row.route}</td>
                      <td className="px-4 py-3 text-sm text-gray-700">{row.meetingInformation}</td>
