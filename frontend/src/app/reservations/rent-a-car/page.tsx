...
export default function ReservationsRentACarPage() {
  ...
  const handleSearch = () => {
    console.log('Searching rent a car reservations with criteria:', {
      dateFrom,
      dateTo,
      sort,
      transactionType,
  ...
  const handleExport = async (type: 'copy' | 'excel' | 'pdf' | 'print') => {
    ...
    if (type === 'print') {
      printTable('#export-table', 'Reservations - Rent a Car');
      return;
    }
    if (type === 'copy') {
    ...
    if (type === 'excel') {
      await exportTableToExcel('reservations-rent-a-car.xlsx', data);
      return;
    }
    await exportTableToPdf('reservations-rent-a-car.pdf', 'Reservations - Rent a Car', data);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="mb-6">
          <h2 className="text-3xl font-light text-gray-800">Rent A Car</h2>
          <div className="mt-2 text-sm text-gray-500">
            <a href="/dashboard" className="text-blue-600 hover:underline">
              Homepage
            </a>{' '}
            <span className="mx-2">»</span>
            <span className="text-gray-400">Rent A Car</span>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-5">
              ...
              <div>
                ...
                >
                  ...
                  <option value="Pick up / Drop date">Pick up / Drop date</option>
                </select>
              </div>
              ...
              {/* Search Button (spans the first two rows on large screens like the screenshot) */}
              <div className="lg:row-span-2 flex items-end justify-end">
                <button
                  type="button"
                  ...
                  <table className="w-full">
                    <thead className="bg-gray-100">
                      <tr>
                        ...
                        <th className="px-4 py-4 text-center text-base font-bold text-gray-900">Car</th>
                        <th className="px-4 py-4 text-center text-base font-bold text-gray-900">Day</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
            ...
            <table id="export-table" className="w-full">
              <thead className="bg-gray-700 text-white">
                <tr>
                  ...
                  <th className="px-4 py-4 text-left font-semibold">Pick up Date / Drop Date</th>
                  <th className="px-4 py-4 text-left font-semibold">Pick-up Location / Drop Location</th>
                  ...
                  <th className="px-4 py-4 text-left font-semibold">Reconfirm</th>
                </tr>
              </thead>
              <tbody>
                {reservations.length === 0 ? (
                  ...
                  reservations.map((row, idx) => (
                    <tr key={idx} className="border-t border-gray-200 hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-sm text-gray-700">{row.pickUpDropDate}</td>
                      <td className="px-4 py-3 text-sm text-gray-700">{row.pickUpDropLocation}</td>
                      ...
                      <td className="px-4 py-3 text-sm text-gray-700">{row.reconfirm}</td>
                    </tr>
                  ))
                )}
              </tbody>
