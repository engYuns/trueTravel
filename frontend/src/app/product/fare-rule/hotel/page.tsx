...
export default function HotelPriceRulesPage() {
  ...
  const [hotelRules, setHotelRules] = useState<any[]>([]);

  const totalRecords = hotelRules.length;
                ...
                {showFinanceDropdown && (
                  <div className="absolute top-full left-0 mt-0 w-56 bg-black rounded-lg shadow-lg py-2 z-[999999] border border-gray-700">
                    <a href="/finance/agency-accounts" className="flex items-center px-4 py-3 text-white hover:bg-gray-800 transition-colors">
                      ...
                      <span className="font-medium text-white">Agency Accounts</span>
                    </a>
                    <a href="/finance/receiving-discharge" className="flex items-center px-4 py-3 text-white hover:bg-gray-800 transition-colors">
                      ...
                      <span className="font-medium text-white">Receiving and Discharge</span>
                    </a>
                    <a href="/finance/virement" className="flex items-center px-4 py-3 text-white hover:bg-gray-800 transition-colors">
                      ...
                      <span className="font-medium text-white">Virement</span>
                    </a>
                  </div>
                )}
              </div>
                ...
                {showReportsDropdown && (
                  <div className="absolute top-full left-0 mt-0 w-56 bg-black rounded-lg shadow-lg py-2 z-[999999] border border-gray-700">
                    <a href="/reports/flight-ticket/sales" className="flex items-center px-4 py-3 text-white hover:bg-gray-800 transition-colors">
                      ...
                      <span className="font-medium text-white">Flight Ticket Sales</span>
                    </a>
                    <a href="/reports/hotel/sales" className="flex items-center px-4 py-3 text-white hover:bg-gray-800 transition-colors">
                      ...
                      <span className="font-medium text-white">Hotel Sales</span>
                    </a>
                    <a href="/reports/rent-a-car/sales" className="flex items-center px-4 py-3 text-white hover:bg-gray-800 transition-colors">
                      ...
                      <span className="font-medium text-white">Rent A Car Sales</span>
                    </a>
                    <a href="/reports/tour/sales" className="flex items-center px-4 py-3 text-white hover:bg-gray-800 transition-colors">
                      ...
                      <span className="font-medium text-white">Tour Sales</span>
                    </a>
                    <a href="/reports/transfer/sales" className="flex items-center px-4 py-3 text-white hover:bg-gray-800 transition-colors">
                      ...
                      <span className="font-medium text-white">Transfer Sales</span>
                    </a>
                  </div>
                )}
              </div>
