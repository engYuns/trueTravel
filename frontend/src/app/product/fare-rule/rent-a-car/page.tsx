...
export default function RentACarPriceRulesPage() {
  ...
  // Table Data
  const [rentACarRules, setRentACarRules] = useState<any[]>([]);

  const totalRecords = rentACarRules.length;
  ...
  return (
    <div className="min-h-screen bg-gray-100">
          ...
          <div className="flex items-center space-x-6 py-3">
            ...
            <a href="/panel" className="flex items-center space-x-2 text-white hover:text-orange-500 transition-colors whitespace-nowrap">
              ...
              >
                ...
                {showFinanceDropdown && (
                  <div className="absolute top-full left-0 mt-0 w-56 bg-black rounded-lg shadow-lg py-2 z-[999999] border border-gray-700">
                    <a href="/finance/agency-accounts" className="flex items-center px-4 py-3 text-white hover:bg-gray-800 transition-colors">
                    ...
                    <a href="/finance/receiving-discharge" className="flex items-center px-4 py-3 text-white hover:bg-gray-800 transition-colors">
                      <svg className="w-4 h-4 mr-3" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="/finance/virement" className="flex items-center px-4 py-3 text-white hover:bg-gray-800 transition-colors">
                      <svg className="w-4 h-4 mr-3" fill="currentColor" viewBox="0 0 24 24">
              ...
              >
                ...
                {showReportsDropdown && (
                  <div className="absolute top-full left-0 mt-0 w-56 bg-black rounded-lg shadow-lg py-2 z-[999999] border border-gray-700">
                    ...
                    <a href="/reports/financial" className="flex items-center px-4 py-3 text-white hover:bg-gray-800 transition-colors">
                      <svg className="w-4 h-4 mr-3" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1.41 16.09V20h-2.67v-1.93c-1.71-.36-3.16-1.46-3.27-3.4h1.96c.1 1.05.82 1.87 2.65 1.87 1.96 0 2.4-.98 2.4-1.59 0-.83-.44-1.61-2.67-2.14-2.48-.6-4.18-1.62-4.18-3.67 0-1.72 1.39-2.84 3.11-3.21V4h2.67v1.95c1.86.45 2.79 1.86 2.85 3.39H14.3c-.05-1.11-.64-1.87-2.22-1.87-1.5 0-2.4.68-2.4 1.64 0 .84.65 1.39 2.67 1.91s4.18 1.39 4.18 3.91c-.01 1.83-1.38 2.83-3.12 3.16z"/>
                      </svg>
                      <span className="font-medium">Financial Report</span>
                    </a>
                    <a href="/reports/agent" className="flex items-center px-4 py-3 text-white hover:bg-gray-800 transition-colors">
                      <svg className="w-4 h-4 mr-3" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/>
                      </svg>
                      <span className="font-medium">Agent Report</span>
                    </a>
                  </div>
                )}
              </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        {/* Breadcrumb */}
        <div className="mb-6">
          <h2 className="text-3xl font-light text-gray-800 mb-2">Rent A Car Price Rules</h2>
          <div className="flex items-center space-x-2 text-sm">
            <a href="/dashboard" className="text-blue-500 hover:underline">Homepage</a>
            <span className="text-gray-400">•</span>
            <span className="text-gray-600">Rent A Car Price Rules</span>
          </div>
        </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-700 text-white">
                    ...
                    <th className="px-4 py-3 text-left font-semibold">Reservation Date *PickupDate</th>
                    <th className="px-4 py-3 text-left font-semibold">*DropoffDate</th>
                  </tr>
                </thead>
                <tbody>
                  {rentACarRules.length === 0 ? (
                    <tr>
                    ...
                    rentACarRules.map((rule, index) => (
                      <tr key={index} className="border-b border-gray-200 hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-4 py-3 text-sm text-gray-700">{rule.day}</td>
                        ...
                        <td className="px-4 py-3 text-sm text-gray-700">{rule.reservationDatePickupDate}</td>
                        <td className="px-4 py-3 text-sm text-gray-700">{rule.dropoffDate}</td>
                      </tr>
                    ))
                  )}
                </tbody>
