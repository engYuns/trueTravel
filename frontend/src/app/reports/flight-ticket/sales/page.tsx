...
export default function ReportsFlightTicketSalesPage() {
  ...
  const [providerFlight, setProviderFlight] = useState('None selected');
  ...
  const [collectiveProforma, setCollectiveProforma] = useState('All');

  const [countryCityCompany, setCountryCityCompany] = useState('Select');
  ...
  const handleExport = async (type: 'copy' | 'excel' | 'pdf' | 'print') => {
    ...
    if (type === 'print') {
      printTable('#export-table', 'Report - Flight Ticket Sales');
      return;
    }
    if (type === 'copy') {
    ...
    if (type === 'excel') {
      await exportTableToExcel('report-flight-ticket-sales.xlsx', rows, exportHeaders);
      return;
    }
    await exportTableToPdf('report-flight-ticket-sales.pdf', 'Report - Flight Ticket Sales', rows, exportHeaders);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="mb-6">
          <h2 className="text-3xl font-light text-gray-800">Flight Ticket Sales</h2>
          <div className="mt-2 text-sm text-gray-500">
            <a href="/dashboard" className="text-blue-600 hover:underline">
              Homepage
            </a>{' '}
            <span className="mx-2">»</span>
            <span className="text-gray-400">Flight Ticket Sales</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-orange-500 rounded-sm overflow-hidden">
          <div className="bg-orange-500 text-white px-5 py-4">
            <h3 className="text-2xl font-medium">Searching Criterias</h3>
          </div>
          ...
          <div className="p-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-10 gap-y-6">
              ...
              <div className="lg:col-span-3">
                ...
                <div className="grid grid-cols-2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-3 py-3 border border-gray-300 bg-gray-100 rounded-none focus:outline-none focus:ring-2 focus:ring-orange-500"
                    />
                  </div>
                  <div className="relative">
                    <div className="pointer-events-none absolute inset-y-0 left-3 flex items-center">{CalendarIcon()}</div>
                ...
                <div className="mt-4">
                  <label className="block text-sm font-medium text-orange-500 mb-2">Provider ( Flight )</label>
                  <select
                    value={providerFlight}
                    onChange={(e) => setProviderFlight(e.target.value)}
                ...
                <div className="mt-4">
                  <label className="block text-sm font-medium text-orange-500 mb-2">Passenger</label>
                  <input
                    type="text"
                    value={passenger}
                    onChange={(e) => setPassenger(e.target.value)}
                    className="w-full px-4 py-3 border border-gray-300 bg-white rounded-none focus:outline-none focus:ring-2 focus:ring-orange-500"
                  />
                </div>

                <div className="mt-4">
                  <label className="block text-sm font-medium text-orange-500 mb-2">Country City ( Company )</label>
                  <select
                    value={countryCityCompany}
                    onChange={(e) => setCountryCityCompany(e.target.value)}
                    className="w-full px-4 py-3 border border-gray-300 bg-gray-100 rounded-none text-gray-700 focus:outline-none focus:ring-2 focus:ring-orange-500"
                  >
              ...
              <div className="lg:col-span-3">
                ...
                <div className="mt-4">
                  <label className="block text-sm font-medium text-orange-500 mb-2">Airline</label>
                  <select
                    value={airline}
                ...
                <div className="mt-16 flex items-center gap-4">
                  <button
                    type="button"
                    className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-md font-medium transition-colors"
                  ...
                  <button
                    type="button"
                    className="inline-flex items-center gap-2 border border-blue-400 text-blue-500 hover:bg-blue-50 px-6 py-3 rounded-md font-medium transition-colors"
              ...
              <div className="lg:col-span-3">
                ...
                <div className="mt-4">
                  <label className="block text-sm font-medium text-orange-500 mb-2">PNR</label>
                  <input
                    type="text"
                    value={pnr}
                ...
                <div className="mt-4">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-3 py-3 border border-gray-300 bg-white rounded-none focus:outline-none focus:ring-2 focus:ring-orange-500"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-3">
                ...
                <div className="mt-4">
                  <label className="block text-sm font-medium text-orange-500 mb-2">Ticket Number</label>
                  <input
                    type="text"
                    value={ticketNumber}
                ...
                <div className="mt-4">
                  <label className="block text-sm font-medium text-orange-500 mb-2">Collective Proforma</label>
                  <select
                    value={collectiveProforma}
                    onChange={(e) => setCollectiveProforma(e.target.value)}
                    className="w-full px-4 py-3 border border-gray-300 bg-gray-100 rounded-none text-gray-700 focus:outline-none focus:ring-2 focus:ring-orange-500"
                  >
                    <option value="All">All</option>
                  </select>
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          <button
            type="button"
            className="inline-flex items-center justify-between gap-3 min-w-[240px] px-5 py-3 border border-blue-500 text-blue-700 bg-white rounded-lg hover:bg-blue-50 transition-colors"
          >
          ...
          <button type="button" className="inline-flex items-center gap-2 px-6 py-3 border border-red-400 text-red-600 bg-white rounded-lg hover:bg-red-50 transition-colors">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-2 12H7v-2h10v2zm0-4H7V9h10v2z" />
            </svg>
            <span className="font-semibold">ARKMAN</span>
          </button>

          <button
            type="button"
            onClick={() => void handleExport('excel')}
            className="inline-flex items-center gap-2 px-6 py-3 border border-blue-400 text-blue-600 bg-white rounded-lg hover:bg-blue-50 transition-colors"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6z" />
            </svg>
            <span className="font-semibold">EXCEL ( ALL )</span>
          </button>
        </div>
        ...
        <div className="mt-6 bg-white border border-gray-200 overflow-hidden">
          <div className="overflow-x-auto">
            <table id="export-table" className="min-w-[1600px] w-full">
              <thead>
                <tr className="bg-gray-600 text-white">
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Transaction time</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Status</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Company</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Company Code</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Ticket Number</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Airline</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">PNR</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">INT DOM</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Route</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Flight Date</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Passenger</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Base Fare</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Airport Tax</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Other Taxes</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Agency Com.</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Sub Agency Com.</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Penalty</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Total</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Payment Type</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Bank</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">User</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Simulator</th>
                  <th className="px-4 py-5 text-left font-semibold">Invoice</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td colSpan={23} className="px-4 py-10 text-center text-gray-700 bg-gray-50">
                    No data available in table
                  </td>
                </tr>
                <tr>
                  <td colSpan={23} className="h-48 bg-gray-100" />
                </tr>
              </tbody>
            </table>
          </div>
