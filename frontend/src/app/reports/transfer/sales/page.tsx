...
export default function ReportsTransferSalesPage() {
  ...
  const handleExport = async (type: 'copy' | 'excel' | 'pdf' | 'print') => {
    ...
    if (type === 'print') {
      printTable('#export-table', 'Report - Transfer Sales');
      return;
    }
    if (type === 'copy') {
    ...
    if (type === 'excel') {
      await exportTableToExcel('report-transfer-sales.xlsx', rows, exportHeaders);
      return;
    }
    await exportTableToPdf('report-transfer-sales.pdf', 'Report - Transfer Sales', rows, exportHeaders);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="mb-6">
          <h2 className="text-3xl font-light text-gray-800">Transfer Sales</h2>
          <div className="mt-2 text-sm text-gray-500">
            <a href="/dashboard" className="text-blue-600 hover:underline">
              Homepage
            </a>{' '}
            <span className="mx-2">»</span>
            <span className="text-gray-400">Transfer Sales</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-orange-500 rounded-sm overflow-hidden">
          ...
          <div className="p-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-10 gap-y-6">
              ...
              <div className="lg:col-span-9 flex flex-col sm:flex-row sm:items-end sm:justify-start gap-3">
                <div className="sm:ml-4 flex flex-col gap-3">
                  <button
                    type="button"
                    className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white px-7 py-3 rounded-md font-medium transition-colors"
        ...
        <div className="mt-6 bg-white border border-gray-200 overflow-hidden">
          <div className="overflow-x-auto">
            <table id="export-table" className="min-w-[1900px] w-full">
              <thead>
                <tr className="bg-gray-600 text-white">
                  ...
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Transfer Date</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Transfer</th>
