  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="mb-6">
          <h2 className="text-3xl font-light text-gray-800">TourSales</h2>
          <div className="mt-2 text-sm text-gray-500">
            <a href="/dashboard" className="text-blue-600 hover:underline">
              Homepage
            </a>{' '}
            <span className="mx-2">»</span>
            <span className="text-gray-400">TourSales</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-orange-500 rounded-sm overflow-hidden">
          ...
          <div className="p-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-10 gap-y-6">
              ...
              {/* Row 2 */}
              <div className="lg:col-span-4">
                <label className="block text-sm font-medium text-orange-500 mb-2">Tour Code</label>
                <input
                  type="text"
                  value={tourCode}
              ...
              <div className="lg:col-span-4">
                <label className="block text-sm font-medium text-orange-500 mb-2">Tour</label>
                <input
                  type="text"
                  value={tour}
              ...
              {/* Actions (left side under fields like screenshot) */}
            ...
            <table className="min-w-[1800px] w-full">
              <thead>
                <tr className="bg-gray-600 text-white">
                  ...
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Start Date</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">End Date</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Tour</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Tour Code</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Passenger</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Pax Count</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Tour Fare</th>
              ...
              <tbody>
                <tr>
                  <td colSpan={21} className="px-4 py-10 text-center text-gray-700 bg-gray-50">
                    No data available in table
                  </td>
                </tr>
                <tr>
                  <td colSpan={21} className="h-48 bg-gray-100" />
                </tr>
              </tbody>
            </table>
          </div>
