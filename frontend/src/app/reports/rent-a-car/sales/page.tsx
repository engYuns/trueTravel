...
export default function ReportsRentACarSalesPage() {
  ...
  const handleExport = async (type: 'copy' | 'excel' | 'pdf' | 'print') => {
    ...
    if (type === 'print') {
      printTable('#export-table', 'Report - Rent a Car Sales');
      return;
    }
    if (type === 'copy') {
    ...
    if (type === 'excel') {
      await exportTableToExcel('report-rent-a-car-sales.xlsx', rows, exportHeaders);
      return;
    }
    await exportTableToPdf('report-rent-a-car-sales.pdf', 'Report - Rent a Car Sales', rows, exportHeaders);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="mb-6">
          <h2 className="text-3xl font-light text-gray-800">Rent A Car Sales</h2>
          <div className="mt-2 text-sm text-gray-500">
            <a href="/dashboard" className="text-blue-600 hover:underline">
              Homepage
            </a>{' '}
            <span className="mx-2">»</span>
            <span className="text-gray-400">Rent A Car Sales</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-orange-500 rounded-sm overflow-hidden">
          ...
          <div className="p-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-10 gap-y-6">
              ...
              <div className="lg:col-span-3">
                <label className="block text-sm font-medium text-orange-500 mb-2">Driver</label>
                <input
                  type="text"
                  value={driver}
              ...
              {/* Actions (placed under Collective Proforma like screenshot) */}
              <div className="lg:col-span-12">
                <div className="flex items-center gap-4 pl-0 lg:pl-[310px]">
                  <button
                    type="button"
        ...
        <div className="mt-6 bg-white border border-gray-200 overflow-hidden">
          <div className="overflow-x-auto">
            <table id="export-table" className="min-w-[1700px] w-full">
              <thead>
                <tr className="bg-gray-600 text-white">
                  ...
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Reservation Number</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Car</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Pick up Date</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Drop Date</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Driver</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Location</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Amount</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Tax</th>
              ...
              <tbody>
                <tr>
                  <td colSpan={20} className="px-4 py-10 text-center text-gray-700 bg-gray-50">
                    No data available in table
                  </td>
                </tr>
                <tr>
                  <td colSpan={20} className="h-48 bg-gray-100" />
                </tr>
              </tbody>
            </table>
          </div>
