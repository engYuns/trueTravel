...
export default function ReportsHotelSalesPage() {
  ...
  const handleExport = async (type: 'copy' | 'excel' | 'pdf' | 'print') => {
    ...
    if (type === 'print') {
      printTable('#export-table', 'Report - Hotel Sales');
      return;
    }
    if (type === 'copy') {
    ...
    if (type === 'excel') {
      await exportTableToExcel('report-hotel-sales.xlsx', rows, exportHeaders);
      return;
    }
    await exportTableToPdf('report-hotel-sales.pdf', 'Report - Hotel Sales', rows, exportHeaders);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="mb-6">
          <h2 className="text-3xl font-light text-gray-800">Hotel Sales</h2>
          <div className="mt-2 text-sm text-gray-500">
            <a href="/dashboard" className="text-blue-600 hover:underline">
              Homepage
            </a>{' '}
            <span className="mx-2">»</span>
            <span className="text-gray-400">Hotel Sales</span>
          </div>
        </div>
            ...
            <table id="export-table" className="min-w-[1600px] w-full">
              <thead>
                <tr className="bg-gray-600 text-white">
                  ...
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Check-In</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Check-Out</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Hotel</th>
                  ...
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Currency</th>
                  <th className="px-4 py-5 text-left font-semibold border-r border-gray-500">Hotel Price</th>
              ...
              <tbody>
                <tr>
                  <td colSpan={22} className="px-4 py-10 text-center text-gray-700 bg-gray-50">
                    No data available in table
                  </td>
                </tr>
                <tr>
                  <td colSpan={22} className="h-48 bg-gray-100" />
                </tr>
              </tbody>
            </table>
          </div>
